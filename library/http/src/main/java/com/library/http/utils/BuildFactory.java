...
import static com.library.http.HttpUtils.API_DOUBAN;
import static com.library.http.HttpUtils.API_GITEE;
import static com.library.http.HttpUtils.API_MTIME;
import static com.library.http.HttpUtils.API_MTIME_TICKET;
import static com.library.http.HttpUtils.API_QSBK;
import static com.library.http.HttpUtils.API_TING;
import static com.library.http.HttpUtils.API_WAN_ANDROID;
        ...
        switch (type) {
            case API_DOUBAN:
                if (doubanHttps == null) {
                    synchronized (BuildFactory.class) {
                        if (doubanHttps == null) {
                            doubanHttps = HttpUtils.getInstance().getBuilder(type).build();
                        }
                    }
                }
